            ...
            <div class="container">
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" name="Sexo"type="radio" name="exampleRadios" id="exampleRadios1" value="Varón">
                                                    <label class="form-check-label" for="Varón">
                                                        Varón
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="Sexo"type="radio" name="exampleRadios" id="exampleRadios2" value="Mujer">
                    ...
                    <div class="col">
                        ...
                        <img src="imagenes/logo.jpg" alt="Transmediterranea" width="500">
